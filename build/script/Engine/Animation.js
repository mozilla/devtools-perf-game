...
ENGINE.Animation.prototype = {
  ...
  set: function(key, more) {
    ...
    if (this.color) {
      this.image = app.getColoredImage(this.image, this.color);
    }
  ...
  step: function(delta) {
    ...
    if (this.loop === false) {
      ...
      if (this.finished) this.collection.remove(this);
    ...
    if (this.attachedTo) {
      ...
      this.y = this.attachedTo.y - this.attachedTo.z + this.offsetY;
    }
  },
